...
document.querySelector('.x-btn').addEventListener('click', () => {
    ...
    document.querySelector('.container').style.cssText = 'background: linear-gradient(rgba(0, 0, 0, 0.7),rgba(0,0,0,0.8)),url(../images/bg2.jpg) center no-repeat;background-size: cover;'
})